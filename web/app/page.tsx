...
export const metadata: Metadata = {
  ...
  description: "Trustless, non-custodial crypto inheritance using multisig wallets and verifiers. Plan your estate for Bitcoin and Ethereum without custodians.",
  keywords: [
    "crypto inheritance",
          ...
          <div className="row align-items-center g-5">
            ...
            <div className="col-12 col-lg-6 order-2 order-lg-1">
              <div className="mb-4 d-flex gap-2 flex-wrap">
                ...
                <span className="badge-chip">Multisig • On‑chain</span>
              ...
              <ul className="list-unstyled mb-4 small text-white-50">
                <li className="mb-2">• <strong>2‑of‑3 multisig</strong> (<a href="https://ethmultisig.org/" target="_blank" rel="noopener" className="text-white-50">EthMultiSig</a> or Safe): You hold Key A; you hand Key B to your heir; Key C is <em>encrypted</em> and escrowed by the protocol (never usable alone).</li>
